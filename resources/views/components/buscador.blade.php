    ...
    <div class="text-center">
        ...
        <div class="input-group d-flex flex-column">
            <form action="/guardar" method="POST">
                @csrf
                <input id="textoBuscador" name="cp" type="search" class="form-control rounded w-100" placeholder="Introduce el código postal" aria-label="Search" aria-describedby="search-addon" style="background-color: transparent; border-color: #FFF; color: #FFF;" />
